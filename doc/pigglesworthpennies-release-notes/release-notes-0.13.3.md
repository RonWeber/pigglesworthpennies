PigglesworthPennies Core version 0.13.3 is now available from:

  <https://download.pigglesworthpennies.org/pigglesworthpennies-0.13.3/>
...
updates will be released anymore. Without security updates, using a pigglesworthpennies
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/pigglesworthpennies-project/pigglesworthpennies/blob/0.13/src/chainparams.cpp#L214).
