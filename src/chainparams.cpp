...
{
    const char* pszTimestamp = "Checkpoint 2/19/18 FFS Here's Atari Coin";
    const CScript genesisOutputScript = CScript() << ParseHex("04891F6A627BFC5D16FCF4FDFB6D4A63E8E0C818274064D026FA9A99603EA16542F55B85006F0F3545EE1024905AB58E4467CCE731325AD4EB098E6163FCDBD879") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1519094863, 1781828, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xdd8b277d9ba1af4acf2b894dbf73772e4566401b2da014d52ad5fa03fa410b5c"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a0ac9cda12a8f0a0ce5091edbaa95b5f748be06061583553a6c944652f791ec"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1519095422, 872740, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf15c4edd5e556d36374fc3352f02c9e883ff0451e3ac4767abcecc2cf3564993"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a0ac9cda12a8f0a0ce5091edbaa95b5f748be06061583553a6c944652f791ec"));
...
public:
    CRegTestParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("f15c4edd5e556d36374fc3352f02c9e883ff0451e3ac4767abcecc2cf3564993")},
            }
        };
