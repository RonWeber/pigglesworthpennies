...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pigglesworthpennies-project/pigglesworthpennies>";
    const std::string URL_WEBSITE = "<https://pigglesworthpennies.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("PigglesworthPennies version %s\n", FormatFullVersion());
}
