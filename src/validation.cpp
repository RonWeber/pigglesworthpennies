...
#if defined(NDEBUG)
# error "PigglesworthPennies cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "PigglesworthPennies Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PPP additional fees, %d delta bytes\n",
