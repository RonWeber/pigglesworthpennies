...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pigglesworthpennies-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pigglesworthpennies-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pigglesworthpennies transaction") + "\n" +
              "  pigglesworthpennies-tx [options] -create [commands]   " + _("Create hex-encoded pigglesworthpennies transaction") + "\n" +
              "\n";
